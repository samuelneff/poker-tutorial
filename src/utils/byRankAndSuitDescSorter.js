...
/**
 * Determines sort order for cards by rank and suit, highest rank to lowest rank, alpha suits. Useful for sorting
 * by rank and in a predictable suit order, but not good for comparison of value since suits do not actually have
 * value. Not exactly same as opposite of byRankAndSuitSorter since suits are ordered alphabetically in both cases.
 * 
 * @param {Card} x First card
 * @param {Card} y Second card
 */
function byRankAndSuitDescSorter(x, y) {
...
export default mixinBaseSorter(byRankAndSuitDescSorter);
